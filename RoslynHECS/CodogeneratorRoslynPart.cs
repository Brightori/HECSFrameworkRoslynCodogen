...
namespace HECSFramework.Core.Generator
{
    public partial class CodeGenerator
    {
        ...
        public const string BluePrintsProviderClass = "BluePrintsProvider";
        ...
        private string GetSystemBluePrint(ClassDeclarationSyntax type)
        {
            ...
            tree.Add(new LeftScopeSyntax(1));
            tree.Add(new RightScopeSyntax(1));
            tree.Add(GetBluePrintRecord(type.Identifier.ValueText, "RegisterSystem"));
            tree.Add(new RightScopeSyntax());
        ...
        private string GetComponentBluePrint(ClassDeclarationSyntax type)
        {
            ...
            tree.Add(new LeftScopeSyntax(1));
            tree.Add(new RightScopeSyntax(1));
            tree.Add(GetBluePrintRecord(type.Identifier.ValueText, "RegisterComponent"));
            tree.Add(new RightScopeSyntax());

            return tree.ToString();
        }

        private ISyntax GetBluePrintRecord(string typeName, string register)
        {
            var tree = new TreeSyntaxNode();
            tree.Add(new ParagraphSyntax());
            tree.Add(new TabSimpleSyntax(1, $"public partial class {BluePrintsProviderClass}"));
            tree.Add(new LeftScopeSyntax(1));
            tree.Add(new TabSimpleSyntax(2, $"private static readonly bool {typeName}{BluePrint} = {register}(typeof({typeName}), typeof({typeName}{BluePrint}));"));
            tree.Add(new RightScopeSyntax(1));
            return tree;
        }
